package Tugas_PBO;
import Tugas_PBO.Matrik;
import  Tugas_PBO.Pecahan;

public class Main {
    public static void main(String[] args) {
        Pecahan pecahan1 = new Pecahan(5, 6);
        Pecahan pecahan2 = new Pecahan(7, 8);

        System.out.println("Pecahan 1: " + pecahan1);
        System.out.println("Pecahan 2: " + pecahan2);

        Pecahan hasilTambah = pecahan1.tambah(pecahan2);
        System.out.println("Hasil Penjumlahan Pecahan : " + hasilTambah);

        Pecahan hasilKurang = pecahan1.kurang(pecahan2);
        System.out.println("Hasil Pengurangan Pecahan : " + hasilKurang);

        Pecahan hasilKali = pecahan1.kali(pecahan2);
        System.out.println("Hasil Perkalian Pecahan : " + hasilKali);

        Pecahan hasilBagi = pecahan1.bagi(pecahan2);
        System.out.println("Hasil Pembagian Pecahan : " + hasilBagi);
